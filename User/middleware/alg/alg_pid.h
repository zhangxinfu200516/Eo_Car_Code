...
public:
    ...
    void Increase_Init(float __K_P, float __K_I, float __K_D,float __Out_Max = 0.0f,float __D_T = 0.001f, float __Dead_Zone = 0.0f);
    ...
    void TIM_Adjust_PID_Increase_PeriodElapsedCallback();
protected:
    //初始化相关常量
