...
enum Enum_LK_Motor_Control_ID : uint8_t
{
    ...
    LK_Motor_Control_Request_Data = 0x9C,
    LK_Motor_Control_Torque = 0xA1,//??????????
    LK_Motor_Control_OneRound_Position_PIDControler = 0xA6,
};
...
protected:
    ...
    uint8_t spinDirection = 0x00;//0x00为顺时针 0x01为逆时针
    float Max_Speed = 360.0f;
